...
_An opinionated, monolithic template for Bevy with cross-platform CI/CD, native + WASM launchers, and managed cross-platform deployment._
...
- Setup your WASM build with one of:
  - [GitHub Pages](#github-pages) _(I'm new to hosting, no equipment)_
  - [Docker](#docker) _(I know what I'm doing)_
